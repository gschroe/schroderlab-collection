...
void log_execution(int argc, char *argv[]) {
    ...
    fprintf(log_fp, "[%s] dxpdb2mrc-bfactor executed with arguments: ", time_str);
...
int main(int argc, char *argv[]) {
    ...
    if (argc < 3) {
        fprintf(stderr, "Usage: %s input.pdb output.mrc [template.mrc] [-angpix value] [-box nx ny nz] [-center cx cy cz] [-res resolution] [-k value]\n", argv[0]);
        return 1;
    }
